...
import com.example.newfristapp.database.DatabaseDAO
import com.example.newfristapp.database.Mycontact
...
class ContactViewModel(
    ...
    private fun formatContact(contact: List<Mycontact>): Spanned {
    ...
    private suspend fun insert(contact: Mycontact) {
